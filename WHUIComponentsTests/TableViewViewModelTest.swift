...
//    }
//    
//    public func apiRequestPromise(type: TableViewState.LoadingType) -> Promise<Data> {
...
//        mockTableViewModel.refreshRequest()
...
//        mockTableViewModel.didSelectRowAt(indexPath)
